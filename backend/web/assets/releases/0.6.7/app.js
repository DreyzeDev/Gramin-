          ...
          <span class="card-inner">
            <span class="card-face card-front">
              ...
              <span class="card-minimal-content">
                <span class="card-minimal-number">••••&nbsp; ••••&nbsp; ••••&nbsp; ${card.number.slice(-4)}</span><span class="card-brandword" aria-label="Gramin Visa"><b>GRAMIN</b><i>VISA</i></span>
                <span class="card-minimal-meta"><span><b>${card.expiry}</b><small>СРОК</small></span><span><b>•••</b><small>CVV</small></span></span>
              </span>
            </span>
