...
function createCardModal() {
  ...
  openModal("Выберите карту", `
    <div class="issuance-hero"><button type="button" class="issuance-close" id="issuance-close" aria-label="Закрыть">×</button><span>Виртуальная карта</span><h4 id="issuance-title">Gramin Black</h4><p id="issuance-price">Бесплатный выпуск</p></div>
